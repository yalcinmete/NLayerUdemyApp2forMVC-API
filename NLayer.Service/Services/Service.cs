    ...
    public class Service<T> : IService<T> where T : class
    {
        ...
        public async Task<T> GetByIdAsync(int id)
        {
            ...
            if (hasProduct == null)
            {
                ...
                throw new NotFoundException($"{typeof(T).Name}({id}) not found"); //Video39sonları.Idye ait nesne bulamazsa 400 değilde 404 dönmeli
            }
            return hasProduct;
        }
        ...
        public async Task RemoveAsync(T entity)
        {
            ...
            await _unitOfWork.CommitAsync(); //unitofwork async olduğu için async metota ekledik.    
        }
